...
const fixtures = {
  test_cases: [
    ...
    },
    {
      ...
      request: 'lntb1500n1pdd932ypp5sa3yxktt5lyuexkcjf0ahy4xsy2ruf3zjtcqeh0swkqzwytl25dqdq0g9jxggp60fshqwscqzysx4kfvu5a6f95zxw9lqjlv5nkvnfrwp509lhrttungj6jrthewtczr9csjl69u54dkcneq99s7ke57j9dlkufmvly5k4z7yn0c09ns0qpzlc6md',
    },
    {
      expected: {
...
fixtures.test_cases.forEach(({expected, request}) => {
  ...
  equal(details.destination, expected.destination, 'Parse destination pubkey');
  ...
  if (expected.mtokens) {
    equal(details.mtokens, expected.mtokens, 'Parse milli-tokens amount');
  }
