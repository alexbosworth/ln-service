...
const {deleteForwardingReputations} = require('lightning/lnd_methods');
const {deletePayments} = require('lightning/lnd_methods');
const {diffieHellmanComputeSecret} = require('lightning/lnd_methods');
...
const {signBytes} = require('lightning/lnd_methods');
const {signMessage} = require('lightning/lnd_methods');
const {signPsbt} = require('lightning/lnd_methods');
const {signTransaction} = require('lightning/lnd_methods');
...
const {updateRoutingFees} = require('lightning/lnd_methods');
const {verifyBackup} = require('lightning/lnd_methods');
const {verifyBackups} = require('lightning/lnd_methods');
const {verifyBytesSignature} = require('lightning/lnd_methods');
